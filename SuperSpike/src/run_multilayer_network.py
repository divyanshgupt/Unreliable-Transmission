...
def run_multilayer_network(input_trains, w1, w2, args):
    ...
    #   print("\n", "Timestep:", t)
        # Spike
        out_1 = src.spike_fn(mem_1, thres, args)
        ...
        # evaluating new membrane potential and synaptic input
        out_2 = src.spike_fn(mem_2, thres, args)
    ...
    # Presynaptic Traces
    ## At hidden layer: 
    presynaptic_traces_1 = src.new_presynaptic_trace(input_trains, args) #final_shape: (nb_inputs, nb_steps)
    ## At output layer: 
    presynaptic_traces_2 = src.new_presynaptic_trace(spk_rec_1, args) #final_shape: (nb_hidden, nb_steps)
    ...
    ## At hidden layer:
    eligibility_1 = src.new_eligibility_trace(hebbian_1, args) #final_shape: (nb_inputs, nb_hidden, nb)
    ## At output layer:
    eligibility_2 = src.new_eligibility_trace(hebbian_2, args) #final_shape: (nb_hidden, nb_outputs, nb_steps)
